  ...
  <table width="100%">
    <tr>
      <td align="center" style="background: linear-gradient(135deg, #4a148c 0%, #9575cd 50%, #b39ddb 100%); padding: 45px 20px; border-radius: 12px;">
        ...
        <p style="color: #f3e5f5; font-size: 1.25em; margin-top: 10px; font-weight: bold; letter-spacing: 1px;">🎓 SMR Graduate | 🚀 ASIR Student | 💻 Web Developer</p>
        <br>
...
<div align="center">
  <table style="background-color: #121214; padding: 20px; border-radius: 12px; border: 1px solid #4a148c;">
    <tr>
      <td align="center">
        <p style="margin-bottom: 15px; color: #b39ddb; font-weight: bold;">¿Te interesa mi perfil? ¡Hablemos!</p>
